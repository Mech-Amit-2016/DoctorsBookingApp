...
public final class SlotDetails_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 int x=0;
     ...
     int sno=1;
      ...
      out.write("\n");
      out.write("        <tr class=\"row ms-5 mt-5\">\n");
      out.write("                      <td class=\"col-2\"><button type=\"button\" class=\"btn btn-light\" style=\"padding: 5px; width: 9rem; height: 5rem; font-size: x-large;\">");
      out.print(sno);
      out.write("</button></td>\n");
      out.write("                      <td class=\"col-2\"><button type=\"button\" class=\"btn btn-light\" style=\"padding: 5px; width: 9rem; height: 5rem; font-size: x-large;\">");
      out.print(hour);
